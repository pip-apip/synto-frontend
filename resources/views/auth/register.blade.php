...
@section('body-attributes', 'class=cover1 justify-center')

@section('body')
    <div class="flex justify-center min-h-screen align-middle">
        <main id="content" class="w-full max-w-md mx-auto my-auto p-6">
            {{-- <a href="index.html" class="header-logo">
                <img src="../assets/img/brand-logos/desktop-light.png" alt="logo" class="mx-auto block">
            </a> --}}
                ...
                <div class="box-body">
                    ...
                    <div class="mt-5">
                        {{-- <button type="button"
                            ...
                            <img src="../assets/img/authentication/social/1.png" class="w-4 h-4" alt="google-img">Sign in
                            with Google
                        </button>
