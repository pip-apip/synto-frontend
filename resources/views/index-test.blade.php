                    ...
                    <ul class="main-menu">
                        ...
                        <li class="slide has-sub">
                            ...
                            <ul class="slide-menu child1">
                                ...
                                <li class="slide"><a href="list-group.html" class="side-menu__item">ListGroup</a>
                                </li>
                        ...
                        <li class="slide has-sub">
                            ...
                            <ul class="slide-menu child1">
                                ...
                                <li class="slide"><a href="form-elements.html"
                                        class="side-menu__item">FormElements</a></li>
                                <li class="slide"><a href="advanced-forms.html"
                                        class="side-menu__item">AdvancedForms</a></li>
                                <li class="slide"><a href="form-input-group.html"
                                        class="side-menu__item">Form-Input-Group</a>
                                </li>
                                <li class="slide"><a href="file-upload.html" class="side-menu__item">File
                                        Uploads</a></li>
                                <li class="slide"><a href="form-checkbox.html"
                                        class="side-menu__item">Form-Checkbox</a></li>
                                ...
                                <li class="slide"><a href="form-layouts.html"
                                        class="side-menu__item">Form-Layouts</a></li>
                                <li class="slide"><a href="form-validations.html"
                                ...
                                <li class="slide has-sub"><a href="javascript:void(0);"
                                    ...
                                    <ul class="slide-menu child2">
                                        <li class="slide"><a href="tables.html"
                                                class="side-menu__item">BasicTables</a></li>
                                        <li class="slide"><a href="datatables.html"
                                                class="side-menu__item">DataTables</a></li>
                        ...
                        <li class="slide has-sub">
                            ...
                            <ul class="slide-menu child1">
                                ...
                                <li class="slide"><a href="apex-charts.html" class="side-menu__item">ApexCharts</a>
                                </li>
                            ...
                            <ul class="slide-menu child1">
                                ...
                                <li class="slide has-sub"><a href="javascript:void(0);"
                                        class="side-menu__item">Mail<i
                                            class="ri ri-arrow-right-s-line side-menu__angle"></i></a>
                                    <ul class="slide-menu child2">
                                        <li class="slide"><a href="mail-inbox.html" class="side-menu__item">Mail</a>
                                        </li>
                                ...
                                <li class="slide has-sub"><a href="javascript:void(0);"
                                    ...
                                    <ul class="slide-menu child2">
                                        ...
                                        <li class="slide"><a href="wishlist.html"
                                                class="side-menu__item">Whislist</a></li>
                                    </ul>
                                </li>
                                ...
                                <li class="slide"><a href="terms.html"
                        ...
                        <li class="slide has-sub">
                            ...
                            <ul class="slide-menu child1">
                                ...
                                <li class="slide has-sub"><a href="javascript:void(0);"
                                    ...
                                    <ul class="slide-menu child2">
                                        <li class="slide"><a href="verfication.html"
                                                class="side-menu__item">Basic</a></li>
                                        <li class="slide"><a href="verfication-cover.html"
                                                class="side-menu__item">Cover-1</a>
                                        </li>
                                        <li class="slide"><a href="verfication-cover2.html"
                                                class="side-menu__item">Cover-2</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="slide"><a href="maintanace.html" class="side-menu__item">Under
                                        Maintanace</a></li>
                                ...
                                <li class="slide has-sub"><a href="javascript:void(0);"
                                        class="side-menu__item">Error Pages<i
                                            class="ri ri-arrow-right-s-line side-menu__angle"></i></a>
                                    <ul class="slide-menu child2">
                                        <li class="slide"><a href="404.html" class="side-menu__item">404Error</a>
                                        </li>
                                        <li class="slide"><a href="500.html" class="side-menu__item">500Error</a>
                                        </li>
                                    </ul>
                                </li>
                            </ul>
                            ...
                            <div class="header-nav-right">
                                <div class="header-country hs-dropdown ti-dropdown hidden sm:block"
                                    ...
                                    <button id="dropdown-flag" type="button"
                                        ...
                                        <img src="{{ asset('assets/img/flags/10.png') }}" alt="flag-img"
                                            ...
                                            <div class="py-2 first:pt-0 last:pb-0">
                                                ...
                                                <div class="ti-dropdown-item">
                                                    <div
                                                        class="flex items-center space-x-2 rtl:space-x-reverse w-full">
                                                        <div class="h-[1.375rem] w-[1.375rem] rounded-sm">
                                                            <img src="{{ asset('assets/img/flags/1.png') }}" alt="flag-img">
                                                        </div>
                                                        <div>
                                                            <p class="text-xs font-medium">
                                                                Argentina
                                                ...
                                                <div class="ti-dropdown-item">
                                                    <div
                                                        class="flex items-center space-x-2 rtl:space-x-reverse w-full">
                                                        <div class="h-[1.375rem] w-[1.375rem] rounded-sm">
                                                            <img src="{{ asset('assets/img/flags/2.png') }}" alt="flag-img">
                                                        </div>
                                                        <div>
                                                            <p class="text-xs font-medium">
                                                                Canada
                                                ...
                                                <div class="ti-dropdown-item">
                                                    <div
                                                        class="flex items-center space-x-2 rtl:space-x-reverse w-full">
                                                        <div class="h-[1.375rem] w-[1.375rem] rounded-sm">
                                                            <img src="{{ asset('assets/img/flags/3.png') }}" alt="flag-img">
                                                        </div>
                                                        <div>
                                                            <p class="text-xs font-medium">
                                                                France
                                                ...
                                                <div class="ti-dropdown-item">
                                                    <div
                                                        class="flex items-center space-x-2 rtl:space-x-reverse w-full">
                                                        <div class="h-[1.375rem] w-[1.375rem] rounded-sm">
                                                            <img src="{{ asset('assets/img/flags/4.png') }}" alt="flag-img">
                                                        </div>
                                                        <div>
                                                            <p class="text-xs font-medium">
                                                                Germany
                                                ...
                                                <div class="ti-dropdown-item">
                                                    <div
                                                        class="flex items-center space-x-2 rtl:space-x-reverse w-full">
                                                        <div class="h-[1.375rem] w-[1.375rem] rounded-sm">
                                                            <img src="{{ asset('assets/img/flags/5.png') }}" alt="flag-img">
                                                        </div>
                                                        <div>
                                                            <p class="text-xs font-medium">
                                                                Italy
                                            ...
                                            <div class="py-2 first:pt-0 last:pb-0" id="allCartsContainer">
                                                ...
                                                <div class="ti-dropdown-item relative header-box">
                                                    <a href="cart.html"
                                                        class="flex items-center space-x-3 rtl:space-x-reverse w-full">
                                                        <img loading="lazy"
                                                            src="{{ asset('assets/img/ecommerce/products/2.png') }}"
                                                            alt="product-img"
                                                            class="avatar p-2 shadow-none  shrink-0 items-center justify-center rounded-sm bg-gray-100 dark:bg-black/20 !ring-transparent">
                                                        <div>
                                                            <p
                                                ...
                                                <div class="ti-dropdown-item relative header-box">
                                                    <a href="cart.html"
                                                        class="flex items-center space-x-3 rtl:space-x-reverse w-full">
                                                        <img loading="lazy"
                                                            src="{{ asset('assets/img/ecommerce/products/9.png') }}"
                                                            alt="product-img"
                                                            class="avatar p-2 shadow-none  shrink-0 items-center justify-center rounded-sm bg-gray-100 dark:bg-black/20 !ring-transparent">
                                                        <div>
                                                            <p
                                                ...
                                                <div class="ti-dropdown-item relative header-box">
                                                    <a href="cart.html"
                                                        class="flex items-center space-x-3 rtl:space-x-reverse w-full">
                                                        <img loading="lazy"
                                                            src="{{ asset('assets/img/ecommerce/products/10.png') }}"
                                                            alt="product-img"
                                                            class="avatar p-2 shadow-none  shrink-0 items-center justify-center rounded-sm bg-gray-100 dark:bg-black/20 !ring-transparent">
                                                        <div>
                                                            <p
                                ...
                                <ul class="flex flex-col">
                                        ...
                                        <a href="javascript:void(0);"
                                            ...
                                            <div class="flex space-x-3 rtl:space-x-reverse w-full">
                                                <img class="avatar avatar-sm rounded-sm"
                                                    src="{{ asset('assets/img/users/2.jpg') }}" alt="Image Description">
                                    ...
                                    <li class="px-0 pt-3 ti-list-group border-0 text-gray-800 dark:text-white">
                                        <a href="javascript:void(0);"
                                            ...
                                            <div class="flex space-x-3 rtl:space-x-reverse w-full">
                                                <img class="avatar avatar-sm rounded-sm"
                                                    src="{{ asset('assets/img/users/3.jpg') }}" alt="Image Description">
                                                <div class="flex w-full">
                                                    <div class="block my-auto">
                                                        <p
                                                            class="block text-sm font-semibold text-gray-800 hover:text-gray-900 my-auto  dark:text-white dark:hover:text-gray-200">
                                    ...
                                    <li class="px-0 pt-3 ti-list-group border-0 text-gray-800 dark:text-white">
                                        <a href="javascript:void(0);"
                                            ...
                                            <div class="flex space-x-3 rtl:space-x-reverse w-full">
                                                <img class="avatar avatar-sm rounded-sm"
                                                    src="{{ asset('assets/img/users/4.jpg') }}" alt="Image Description">
                                                <div class="flex w-full">
                                                    <div class="block my-auto">
                                                        <p
                                                            class="block text-sm font-semibold text-gray-800 hover:text-gray-900 my-auto  dark:text-white dark:hover:text-gray-200">
                                    ...
                                    <li class="px-0 pt-3 ti-list-group border-0 text-gray-800 dark:text-white">
                                        <a href="javascript:void(0);"
                                            ...
                                            <div class="flex space-x-3 rtl:space-x-reverse w-full">
                                                <img class="avatar avatar-sm rounded-sm"
                                                    src="{{ asset('assets/img/users/5.jpg') }}" alt="Image Description">
                                                <div class="flex w-full">
                                                    <div class="block my-auto">
                                                        <p
                                                            class="block text-sm font-semibold text-gray-800 hover:text-gray-900 my-auto  dark:text-white dark:hover:text-gray-200">
                                    ...
                                    <li class="px-0 pt-3 ti-list-group border-0 text-gray-800 dark:text-white">
                                        <a href="javascript:void(0);"
                                            ...
                                            <div class="flex space-x-3 rtl:space-x-reverse w-full">
                                                <img class="avatar avatar-sm rounded-sm"
                                                    src="{{ asset('assets/img/users/6.jpg') }}" alt="Image Description">
                                                <div class="flex w-full">
                                                    <div class="block my-auto">
                                                        <p
                                                            class="block text-sm font-semibold text-gray-800 hover:text-gray-900 my-auto  dark:text-white dark:hover:text-gray-200">
                                    ...
                                    <li class="px-0 pt-3 pb-0 ti-list-group border-0 text-gray-800 dark:text-white">
                                        <a href="javascript:void(0);"
                                            ...
                                            <div class="flex space-x-3 rtl:space-x-reverse w-full">
                                                <img class="avatar avatar-sm rounded-sm"
                                                    src="{{ asset('assets/img/users/10.jpg') }}" alt="Image Description">
                                                <div class="flex w-full">
                                                    <div class="block my-auto">
                                                        <p
                                                            class="block text-sm font-semibold text-gray-800 hover:text-gray-900 my-auto  dark:text-white dark:hover:text-gray-200">
                                            ...
                                            <div class="flex items-center">
                                                <div class="leading-none">
                                                    <img class="avatar avatar-sm rounded-full"
                                                        src="{{ asset('assets/img/ecommerce/jpg/1.jpg') }}" alt="image">
                                                </div>
                                    ...
                                    <li class="p-0 mb-6 ti-list-group border-0 text-gray-800 dark:text-white">
                                        <a href="javascript:void(0);" class="w-full">
                                            <div class="flex items-center">
                                                <div class="leading-none">
                                                    <img class="avatar avatar-sm rounded-full"
                                                        src="{{ asset('assets/img/ecommerce/jpg/2.jpg') }}" alt="image">
                                                </div>
                                                <div class="flex-auto ltr:ml-2 rtl:mr-2">
                                    ...
                                    <li class="p-0 mb-6 ti-list-group border-0 text-gray-800 dark:text-white">
                                        <a href="javascript:void(0);" class="w-full">
                                            <div class="flex items-center">
                                                <div class="leading-none">
                                                    <img class="avatar avatar-sm rounded-full"
                                                        src="{{ asset('assets/img/ecommerce/jpg/3.jpg') }}" alt="image">
                                                </div>
                                                <div class="flex-auto ltr:ml-2 rtl:mr-2">
                                    ...
                                    <li class="p-0 mb-6 ti-list-group border-0 text-gray-800 dark:text-white">
                                        <a href="javascript:void(0);" class="w-full">
                                            <div class="flex items-center">
                                                <div class="leading-none">
                                                    <img class="avatar avatar-sm rounded-full"
                                                        src="{{ asset('assets/img/ecommerce/jpg/4.jpg') }}" alt="image">
                                                </div>
                                                <div class="flex-auto ltr:ml-2 rtl:mr-2">
                                    ...
                                    <li class="p-0 mb-6 ti-list-group border-0 text-gray-800 dark:text-white">
                                        <a href="javascript:void(0);" class="w-full">
                                            <div class="flex items-center">
                                                <div class="leading-none">
                                                    <img class="avatar avatar-sm rounded-full"
                                                        src="{{ asset('assets/img/ecommerce/jpg/6.jpg') }}" alt="image">
                                                </div>
                                                <div class="flex-auto ltr:ml-2 rtl:mr-2">
                                    ...
                                    <li class="p-0 mb-0 ti-list-group border-0 text-gray-800 dark:text-white">
                                        <a href="javascript:void(0);" class="w-full">
                                            <div class="flex items-center">
                                                <div class="leading-none">
                                                    <img class="avatar avatar-sm rounded-full"
                                                        src="{{ asset('assets/img/ecommerce/jpg/5.jpg') }}" alt="image">
                                                </div>
                                                <div class="flex-auto ltr:ml-2 rtl:mr-2">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td
                                                    ...
                                                    <img src="{{ asset('assets/img/ecommerce/products/13.png') }}"
                                            ...
                                            <tr>
                                                <td
                                                    class="leading-none !text-gray-800 dark:!text-white !p-[0.65rem] min-w-[180px] truncate">
                                                    <img src="{{ asset('assets/img/ecommerce/products/14.png') }}"
                                                        class="avatar avatar-sm p-2 rounded-full bg-gray-100 dark:bg-black/20 ltr:mr-2 rtl:ml-2"
                                            ...
                                            <tr>
                                                <td
                                                    class="leading-none !text-gray-800 dark:!text-white !p-[0.65rem] min-w-[180px] truncate">
                                                    <img src="{{ asset('assets/img/ecommerce/products/15.png') }}"
                                                        class="avatar avatar-sm p-2 rounded-full bg-gray-100 dark:bg-black/20 ltr:mr-2 rtl:ml-2"
                                            ...
                                            <tr>
                                                <td
                                                    class="leading-none !text-gray-800 dark:!text-white !p-[0.65rem] min-w-[180px] truncate">
                                                    <img src="{{ asset('assets/img/ecommerce/products/16.png') }}"
                                                        class="avatar avatar-sm p-2 rounded-full bg-gray-100 dark:bg-black/20 ltr:mr-2 rtl:ml-2"
                                            ...
                                            <tr>
                                                <td
                                                    class="leading-none !text-gray-800 dark:!text-white !p-[0.65rem] min-w-[180px] truncate">
                                                    <img src="{{ asset('assets/img/ecommerce/products/17.png') }}"
                                                        class="avatar avatar-sm p-2 rounded-full bg-gray-100 dark:bg-black/20 ltr:mr-2 rtl:ml-2"
                                            ...
                                            <tr>
                                                <td
                                                    class="leading-none !text-gray-800 dark:!text-white !p-[0.65rem] min-w-[180px] truncate">
                                                    <img src="{{ asset('assets/img/ecommerce/products/18.png') }}"
                                                        class="avatar avatar-sm p-2 rounded-full bg-gray-100 dark:bg-black/20 ltr:mr-2 rtl:ml-2"
                                        ...
                                        <tbody class="">
                                            ...
                                            <tr class="">
                                                ...
                                                <td>
                                                    <div class="flex space-x-3 rtl:space-x-reverse w-full">
                                                        <img class="avatar rounded-sm bg-gray-100 dark:bg-black/20 p-2"
                                                            src="{{ asset('assets/img/ecommerce/products/3.png') }}"
                                                            alt="Image Description">
                                                        <div class="block w-full my-auto">
                                                            <span
                                            ...
                                            <tr class="">
                                                ...
                                                <td>
                                                    <div class="flex space-x-3 rtl:space-x-reverse w-full">
                                                        <img class="avatar rounded-sm bg-gray-100 dark:bg-black/20 p-2"
                                                            src="{{ asset('assets/img/ecommerce/products/4.png') }}"
                                                            alt="Image Description">
                                                        <div class="block w-full my-auto">
                                                            <span
                                            ...
                                            <tr class="">
                                                ...
                                                <td>
                                                    <div class="flex space-x-3 rtl:space-x-reverse w-full">
                                                        <img class="avatar rounded-sm bg-gray-100 dark:bg-black/20 p-2"
                                                            src="{{ asset('assets/img/ecommerce/products/5.png') }}"
                                                            alt="Image Description">
                                                        <div class="block w-full my-auto">
                                                            <span
                                                ...
                                                <td>
                                                    <div class="flex space-x-3 rtl:space-x-reverse text-start">
                                                        <img class="avatar avatar-sm rounded-sm"
                                                            src="{{ asset('assets/img/users/9.jpg') }}" alt="Image Description">
                                                        <div class="block my-auto">
                                                            <p
                                                                class="block text-sm font-semibold my-auto text-gray-800 dark:text-white">
                                                                Roman Killon</p>
                                            ...
                                            <tr class="">
                                                ...
                                                <td>
                                                    <div class="flex space-x-3 rtl:space-x-reverse w-full">
                                                        <img class="avatar rounded-sm bg-gray-100 dark:bg-black/20 p-2"
                                                            src="{{ asset('assets/img/ecommerce/products/6.png') }}"
                                                            alt="Image Description">
                                                        <div class="block w-full my-auto">
                                                            <span
