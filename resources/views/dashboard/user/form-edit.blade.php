                        ...
                        <form class="ti-custom-validation" novalidate="">
                            <div class="grid lg:grid-cols-2 gap-6">
                                <div class="space-y-2">
                                    ...
                                    <input type="text" class="firstName my-auto ti-form-input" placeholder="Firstname"
                                        value="John mark" required="">
                                    <span class="firstNameError text-red-500 text-xs hidden">error</span>
                                </div>
                                <div class="space-y-2">
                                    <label class="ti-form-label mb-0">Last Name</label>
                                    <input type="text" class="lastName my-auto ti-form-input" placeholder="Lastname"
                                        required="">
                                    <span class="lastNameError text-red-500 text-xs hidden">error</span>
                                </div>
                                <div class="space-y-2">
                                    <label class="ti-form-label mb-0">Phone Number</label>
                                    <input type="number" class="phonenumber my-auto ti-form-input"
                                ...
                                <div class="space-y-2">
                                    ...
                                    <input type="email" class="email-address my-auto ti-form-input"
                                ...
                                <div class="space-y-2">
                                    ...
                                    <ul class="flex flex-col sm:flex-row">
                                        <li
                                            ...
                                            <div class="relative flex items-start w-full">
                                                <div class="flex items-center h-5">
                                                    <input id="ti-radio-validation-11" name="ti-radio-validation"
                                        ...
                                        <li
                                            ...
                                            <div class="relative flex items-start w-full">
                                                <div class="flex items-center h-5">
                                                    <input id="ti-radio-validation-12" name="ti-radio-validation"
                                        ...
                                        <li
                                            ...
                                            <div class="relative flex items-start w-full">
                                                <div class="flex items-center h-5">
                                                    <input id="ti-radio-validation-13" name="ti-radio-validation"
                                                        type="radio" class="ti-form-radio" required="">
                                                </div>
                            ...
                            <div class="my-5">
                                <input type="checkbox" class="validationCheckbox ti-form-checkbox mt-0.5"
                                    id="hs-checkbox-group-12" required="">
                            ...
                            <button value="Login Now" type="submit"
