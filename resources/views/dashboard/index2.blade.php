                    ...
                    <div class="box-body">
                        <div class="flex">
                            <div class="flex space-x-3 rtl:space-x-reverse">
                                ...
                                <h6 class="text-lg font-medium text-gray-800 mb-2 dark:text-white my-auto">Total Revenue
                                </h6>
                            </div>
                    ...
                    <div class="box-body">
                        <div class="flex">
                            <div class="flex space-x-3 rtl:space-x-reverse">
                                ...
                                <h6 class="text-lg font-medium text-gray-800 mb-2 dark:text-white my-auto">Total Products
                                </h6>
                            </div>
                    ...
                    <div class="box-body">
                        <div class="flex">
                            <div class="flex space-x-3 rtl:space-x-reverse">
                                ...
                                <h6 class="text-lg font-medium text-gray-800 mb-2 dark:text-white my-auto">Total Expenses
                                </h6>
                            </div>
                                ...
                                <a href="javascript:void(0);" class="w-full">
                                    <div class="flex items-center">
                                        ...
                                        <div class="flex-auto ltr:ml-2 rtl:mr-2">
                                            ...
                                            <p class="text-xs text-gray-400 dark:text-white/80 mb-0 !font-normal">Mobiles
                                            </p>
                                        </div>
                                ...
                                <a href="javascript:void(0);" class="w-full">
                                    <div class="flex items-center">
                                        ...
                                        <div class="flex-auto ltr:ml-2 rtl:mr-2">
                                            ...
                                            <p class="text-xs text-gray-400 dark:text-white/80 mb-0 !font-normal">Clothing
                                            </p>
                                        </div>
                                        <div class="block text-end">
                                ...
                                <a href="javascript:void(0);" class="w-full">
                                    <div class="flex items-center">
                                        ...
                                        <div class="flex-auto ltr:ml-2 rtl:mr-2">
                                            ...
                                            <p class="text-xs text-gray-400 dark:text-white/80 mb-0 !font-normal">Furniture
                                            </p>
                                        </div>
                                        <div class="block text-end">
